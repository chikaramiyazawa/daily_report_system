...
/**
 * Servlet implementation class SearchUseReset
 */
@WebServlet("/search/usereset")
public class SearchUseReset extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchUseReset() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Searcher s = em.find(Searcher.class, Integer.parseInt(request.getParameter("id")));
