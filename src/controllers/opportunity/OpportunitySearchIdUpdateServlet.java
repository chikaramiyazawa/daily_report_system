...
/**
 * Servlet implementation class OpportunitySearchIdUpdateServlet
 */
@WebServlet("/opportunity/idupdate")
public class OpportunitySearchIdUpdateServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public OpportunitySearchIdUpdateServlet() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/views/ops/searchidupdate_index.jsp");
