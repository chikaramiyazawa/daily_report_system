...
public class Follow {
    ...
    @Column(name = "followerdname" , nullable = false)
    private String followerdname;
    ...
    public String getFollowerdname() {
        return followerdname;
    }

    public void setFollowerdname(String followerdname) {
        this.followerdname = followerdname;
    }
